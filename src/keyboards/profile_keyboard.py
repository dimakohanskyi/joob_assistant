...
def get_experience_confirmation_keyboard():
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [
            InlineKeyboardButton(text="✅ Yes", callback_data="confirm_experience_update"),
            InlineKeyboardButton(text="❌ No", callback_data="cancel_experience_update")
        ],
        [InlineKeyboardButton(text="⬅️ Back", callback_data="create_profile")]
    ])
    return keyboard
